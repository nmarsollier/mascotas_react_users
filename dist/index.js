...
var changePassword = function changePassword(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(mascotas_react_common.environment.backendUrl + "/v1/user/password", payload)).then(function (res) {
...
var newUser = function newUser(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(mascotas_react_common.environment.backendUrl + "/v1/user", payload)).then(function (res) {
...
var reloadCurrentUser = function reloadCurrentUser() {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.get(mascotas_react_common.environment.backendUrl + "/v1/users/current")).then(function (res) {
...
var login = function login(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(mascotas_react_common.environment.backendUrl + "/v1/user/signin", payload)).then(function (res) {
        mascotas_react_store.updateStoreToken(res.data.token);
        setCurrentToken(res.data.token);
        return Promise.resolve(res.data);
      });
  ...
  try {
    ...
    return Promise.resolve(_finallyRethrows(function () {
      return _catch(function () {
        return Promise.resolve(axios$1.get(mascotas_react_common.environment.backendUrl + "/v1/user/signout")).then(function () {
