...
var changePassword = function changePassword(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(environment.backendUrl + "/v1/user/password", payload)).then(function (res) {
...
var newUser = function newUser(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(environment.backendUrl + "/v1/user", payload)).then(function (res) {
...
var reloadCurrentUser = function reloadCurrentUser() {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.get(environment.backendUrl + "/v1/users/current")).then(function (res) {
...
var login = function login(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios$1.post(environment.backendUrl + "/v1/user/signin", payload)).then(function (res) {
        updateStoreToken(res.data.token);
        setCurrentToken(res.data.token);
        return Promise.resolve(res.data);
      });
  ...
  try {
    ...
    return Promise.resolve(_finallyRethrows(function () {
      return _catch(function () {
        return Promise.resolve(axios$1.get(environment.backendUrl + "/v1/user/signout")).then(function () {
...
if (getCurrentToken()) {
  axios$1.defaults.headers.common.Authorization = "bearer " + getCurrentToken();
}
...
function LoginUser(props) {
  ...
  return /*#__PURE__*/React__default.createElement(GlobalContent, null, /*#__PURE__*/React__default.createElement(FormTitle, null, "Login"), /*#__PURE__*/React__default.createElement(Form, null, /*#__PURE__*/React__default.createElement(FormInput, {
    label: "Usuario",
    name: "login",
  ...
  }), /*#__PURE__*/React__default.createElement(FormPassword, {
    label: "Password",
    name: "password",
    errorHandler: errorHandler,
    onChange: function onChange(event) {
...
function ChangeUserPassword(props) {
  ...
  return /*#__PURE__*/React__default.createElement(GlobalContent, null, /*#__PURE__*/React__default.createElement(FormTitle, null, "Cambiar Password"), /*#__PURE__*/React__default.createElement(Form, null, /*#__PURE__*/React__default.createElement(FormPassword, {
...
function RegisterUser(props) {
  ...
  return /*#__PURE__*/React__default.createElement(GlobalContent, null, /*#__PURE__*/React__default.createElement(FormTitle, null, "Registrar Usuario"), /*#__PURE__*/React__default.createElement(Form, null, /*#__PURE__*/React__default.createElement(FormInput, {
    label: "Login",
    name: "login",
    value: login,
    errorHandler: errorHandler,
