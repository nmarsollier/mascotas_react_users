...
var changePassword = function changePassword(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.post(environment.backendUrl + "/v1/user/password", payload)).then(function (res) {
...
var newUser = function newUser(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.post(environment.backendUrl + "/v1/user", payload)).then(function (res) {
...
var reloadCurrentUser = function reloadCurrentUser() {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.get(environment.backendUrl + "/v1/users/current")).then(function (res) {
...
var login = function login(payload) {
  try {
    return Promise.resolve(_catch(function () {
      return Promise.resolve(axios.post(environment.backendUrl + "/v1/user/signin", payload)).then(function (res) {
        updateStoreToken(res.data.token);
        setCurrentToken(res.data.token);
        reloadCurrentUser().then();
        return Promise.resolve(res.data);
  ...
  try {
    ...
    return Promise.resolve(_finallyRethrows(function () {
      return _catch(function () {
        return Promise.resolve(axios.get(environment.backendUrl + "/v1/user/signout")).then(function () {
